...
octopus -R GRCh38_full_analysis_set_plus_decoy_hla.fa -I crams/HG00405.final.cram crams/HG00403.final.cram crams/HG00404.final.cram -M HG00404 -F HG00403 --filter-vcf octopus_calls/trio1.vcf.gz --forest octopus_forests_germline.v0.7.4.forest -o octopus_forest/trio1.vcf.gz --threads 95
